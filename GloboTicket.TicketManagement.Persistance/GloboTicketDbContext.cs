...
namespace GloboTicket.TicketManagement.Persistance
{
    public class GloboTicketDbContext: DbContext
    {
        ...
        // apply configurationa and apply seed data
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            // search for configurations in the assembly and apply them to model
        ...
        // save audit data before calling SaveChangesAsync
