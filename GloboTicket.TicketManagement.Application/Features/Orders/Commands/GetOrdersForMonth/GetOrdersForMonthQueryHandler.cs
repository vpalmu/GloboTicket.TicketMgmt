...
{
    public class GetOrdersForMonthQueryHandler : IRequestHandler<GetOrdersForMonthQuery, GetOrdersForMonthQueryResponse>
    {
        ...
        public async Task<GetOrdersForMonthQueryResponse> Handle(GetOrdersForMonthQuery request, CancellationToken cancellationToken)
        {
            ...
            return new GetOrdersForMonthQueryResponse()
            {
                PagedOrdersForMonth = new PagedOrdersForMonthVm() { Count = count, OrdersForMonth = orders, Page = request.Page, Size = request.Size }
            };
        }
    }
}
